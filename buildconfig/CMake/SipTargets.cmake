...
function ( mtd_add_sip_module )
  find_file ( _sipmodule_template_path sipmodule_template.sip.in PATHS ${CMAKE_MODULE_PATH} )
  if ( NOT _sipmodule_template_path )
    message ( FATAL "Unable to find sipmodule_template.sip.in in cmake module path. Cannot continue." )
  endif ()
